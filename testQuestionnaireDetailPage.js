...
const questionnaireId = `${__ENV.K6_TARGET_VIEW_QUESTIONNAIRE_ID}`
...
export default function(data) {
  ...
  let response = visitPage(serverUrl + 'questionnaire/' + questionnaireId + '/')
  const PAGE_KEYWORD = 'questionnaire-detail'
